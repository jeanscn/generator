 ...
 * @version 3.0
 */
public class DictData extends AbstractAnnotation{

    public static final String ANNOTATION_NAME = "@DictData";
    ...
    public DictData() {
        super();
        this.addImports("com.vgosoft.core.annotation.DictData");
    }

    public DictData(String value) {
        this();
        this.value = value;
    }
