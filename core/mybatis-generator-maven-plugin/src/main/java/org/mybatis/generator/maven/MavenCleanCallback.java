 ...
 * @author Jeff Butler
 */
public class MavenCleanCallback extends DefaultShellCallback {
    private MyBatisClearMojo mybatisGeneratorMojo;

    public MavenCleanCallback(MyBatisClearMojo mybatisGeneratorMojo, boolean overwrite) {
        super(overwrite);
