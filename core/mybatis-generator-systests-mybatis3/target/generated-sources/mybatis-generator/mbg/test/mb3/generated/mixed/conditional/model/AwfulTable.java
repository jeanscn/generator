...
public class AwfulTable implements Serializable {
    ...
    /**
     */
    @ColumnMeta(value = "CuStOmEr iD",description = "null",size =32,order = 21,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "CuStOmEr iD")
    private Integer customerId;

    /**
     */
    @ColumnMeta(value = "first name",description = "null",size =30,order = 22)
    @ApiModelProperty(value = "null",name = "first name")
    private String firstFirstName;

    /**
     */
    @ColumnMeta(value = "FIRST_NAME",description = "null",size =30,order = 23)
    @ApiModelProperty(value = "null",name = "FIRST_NAME")
    private String secondFirstName;

    /**
     */
    @ColumnMeta(value = "FIRSTNAME",description = "null",size =30,order = 24)
    @ApiModelProperty(value = "null",name = "FIRSTNAME")
    private String thirdFirstName;

    /**
     */
    @ColumnMeta(value = "last name",description = "null",size =30,order = 25)
    @ApiModelProperty(value = "null",name = "last name")
    private String lastName;

    /**
     */
    @ColumnMeta(value = "E_MAIL",description = "null",size =30,order = 26)
    @ApiModelProperty(value = "null",name = "E_MAIL")
    private String eMail;

    /**
     */
    @ColumnMeta(value = "_id1",description = "null",size =32,order = 27,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "_id1")
    private Integer id1;

    /**
     */
    @ColumnMeta(value = "$id2",description = "null",size =32,order = 28,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "$id2")
    private Integer id2;

    /**
     */
    @ColumnMeta(value = "id5_",description = "null",size =32,order = 29,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "id5_")
    private Integer id5;

    /**
     */
    @ColumnMeta(value = "id6$",description = "null",size =32,order = 30,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "id6$")
    private Integer id6;

    /**
     */
    @ColumnMeta(value = "id7$$",description = "null",size =32,order = 31,type = JDBCType.INTEGER)
    @ApiModelProperty(value = "null",name = "id7$$")
    private Integer id7;

    /**
     */
    @ColumnMeta(value = "EMAILADDRESS",description = "null",size =30,order = 32)
    @ApiModelProperty(value = "null",name = "EMAILADDRESS")
    private String emailaddress;

    /**
     */
    @ColumnMeta(value = "from",description = "null",size =30,order = 33)
    @ApiModelProperty(value = "null",name = "from")
    private String from;

    /**
     */
    @ColumnMeta(value = "ACTIVE",description = "null",size =1,order = 34,type = JDBCType.BIT)
    @ApiModelProperty(value = "null",name = "ACTIVE")
    private boolean active;

    /**
     */
    @ColumnMeta(value = "ACTIVE1",description = "null",size =0,order = 35,type = JDBCType.BOOLEAN)
    @ApiModelProperty(value = "null",name = "ACTIVE1")
    private Boolean active1;

    /**
     */
    @ColumnMeta(value = "ACTIVE2",description = "null",size =22,order = 36,type = JDBCType.BIT)
    @ApiModelProperty(value = "null",name = "ACTIVE2")
    private byte[] active2;

    /**
     */
    @ColumnMeta(value = "CLASS",description = "null",size =5,order = 37)
