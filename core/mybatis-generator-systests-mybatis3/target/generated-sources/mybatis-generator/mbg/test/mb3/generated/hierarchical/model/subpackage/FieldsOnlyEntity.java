 ...
 */
@Repository
@TableMeta(value = "FieldsOnly", descript = "", beanname = "fieldsOnlyEntityImpl")
@ApiModel(value = "FieldsOnlyEntity", description = "")
@Setter
@Getter
public class FieldsOnlyEntity {
    ...
    public FieldsOnlyEntity(Integer integerfield, Double doublefield, Double floatfield) {
        this.integerfield = integerfield;
        this.doublefield = doublefield;
        this.floatfield = floatfield;
    }

    public FieldsOnlyEntity() {
        super();
    }
