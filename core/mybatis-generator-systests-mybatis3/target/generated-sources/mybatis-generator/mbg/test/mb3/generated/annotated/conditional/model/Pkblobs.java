...
public class Pkblobs implements Serializable {
    ...
    /**
     */
    @ColumnMeta(value = "ID",description = "null",size =32,order = 21,type = JDBCType.INTEGER)
    ...
    /**
     */
    @ColumnMeta(value = "CHARACTERLOB",description = "null",size =5120,order = 24,type = JDBCType.CLOB)
